...
const TArray<FToolPlayMCPBridgeCommandSpec>& FToolPlayMCPToolRegistry::GetCommandSpecs()
{
	static const TArray<FToolPlayMCPBridgeCommandSpec> Specs = {
		...
		{TEXT("remove_niagara_user_parameter"), TEXT("niagara"), TEXT("Remove one exposed User parameter from a Niagara System. This does not automatically disconnect module links that reference the same User.* name."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"user_parameter\":\"User.SourceMesh\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("user_parameter"), StringProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("user_parameter")})), TEXT("niagara_system")},
		...
		{TEXT("list_niagara_renderers"), TEXT("niagara"), TEXT("List renderers on an emitter with type, class, index, and editable property snapshots."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter")})), TEXT("niagara_system")},
		{TEXT("get_niagara_renderer_schema"), TEXT("niagara"), TEXT("Describe editable properties for a renderer type. Supported types include sprite, mesh, ribbon, light, and component."), TEXT("{\"renderer_type\":\"mesh\"}"), Schema(Prop(TEXT("renderer_type"), StringProp()), Required({TEXT("renderer_type")})), TEXT("niagara_system")},
		{TEXT("add_niagara_renderer"), TEXT("niagara"), TEXT("Add a renderer to an emitter. renderer_type supports sprite, mesh, ribbon, light, and component; mesh_asset_path can initialize mesh renderers."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"renderer_type\":\"mesh\",\"target_index\":-1,\"mesh_asset_path\":\"/Engine/BasicShapes/Sphere.Sphere\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("renderer_type"), StringProp()), Prop(TEXT("target_index"), IntegerProp()), Prop(TEXT("mesh_asset_path"), StringProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("renderer_type")})), TEXT("niagara_system")},
		{TEXT("remove_niagara_renderer"), TEXT("niagara"), TEXT("Remove one renderer from an emitter by renderer index."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"renderer_index\":0}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("renderer_index"), IntegerProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("renderer_index")})), TEXT("niagara_system")},
		{TEXT("set_niagara_renderer_property"), TEXT("niagara"), TEXT("Set one exposed renderer property by renderer index. Call get_niagara_renderer_schema first; value uses Unreal import-text strings for reflected properties."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"renderer_index\":0,\"property\":\"FacingMode\",\"value\":\"Velocity\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("renderer_index"), IntegerProp()), Prop(TEXT("property"), StringProp()), Prop(TEXT("value"), AnyProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("renderer_index"), TEXT("property"), TEXT("value")})), TEXT("niagara_system")},
		{TEXT("list_niagara_simulation_stages"), TEXT("niagara"), TEXT("List simulation stages on an emitter with index, name, script usage id, and editable properties."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter")})), TEXT("niagara_system")},
		{TEXT("add_niagara_simulation_stage"), TEXT("niagara"), TEXT("Add a generic Niagara simulation stage to an emitter and reset the graph for a simulation-stage output."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"stage_name\":\"Advect\",\"target_index\":-1}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("stage_name"), StringProp()), Prop(TEXT("target_index"), IntegerProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter")})), TEXT("niagara_system")},
		{TEXT("remove_niagara_simulation_stage"), TEXT("niagara"), TEXT("Remove one simulation stage from an emitter by stage index."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"stage_index\":0}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("stage_index"), IntegerProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("stage_index")})), TEXT("niagara_system")},
		{TEXT("move_niagara_simulation_stage"), TEXT("niagara"), TEXT("Move one simulation stage to a target index."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"stage_index\":0,\"target_index\":1}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("stage_index"), IntegerProp()), Prop(TEXT("target_index"), IntegerProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("stage_index"), TEXT("target_index")})), TEXT("niagara_system")},
		{TEXT("set_niagara_simulation_stage_property"), TEXT("niagara"), TEXT("Set one exposed simulation stage property by stage index. Use value strings in Unreal import-text format."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"stage_index\":0,\"property\":\"bEnabled\",\"value\":\"False\"}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("stage_index"), IntegerProp()), Prop(TEXT("property"), StringProp()), Prop(TEXT("value"), AnyProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("stage_index"), TEXT("property"), TEXT("value")})), TEXT("niagara_system")},
		{TEXT("configure_niagara_sprite_renderer"), TEXT("niagara"), TEXT("Compatibility wrapper for old clients. Prefer list/get_schema/add/remove/set renderer actions instead."), TEXT("{\"system_asset_path\":\"/Game/FX/NS_System.NS_System\",\"emitter\":\"e0\",\"renderer_index\":0,\"facing_mode\":\"FaceCamera\",\"alignment\":\"VelocityAligned\",\"pivot_u\":0.5,\"pivot_v\":1.0}"), Schema(FString::Join(TArray<FString>{Prop(TEXT("system_asset_path"), StringProp()), Prop(TEXT("emitter"), StringProp()), Prop(TEXT("renderer_index"), IntegerProp()), Prop(TEXT("facing_mode"), StringProp()), Prop(TEXT("alignment"), StringProp()), Prop(TEXT("pivot_u"), NumberProp()), Prop(TEXT("pivot_v"), NumberProp())}, TEXT(",")), Required({TEXT("system_asset_path"), TEXT("emitter"), TEXT("renderer_index"), TEXT("facing_mode"), TEXT("alignment"), TEXT("pivot_u"), TEXT("pivot_v")})), TEXT("niagara_system")},
