...
const TArray<FToolPlayMCPBridgeCommandSpec>& FToolPlayMCPToolRegistry::GetCommandSpecs()
{
	static const TArray<FToolPlayMCPBridgeCommandSpec> Specs = {
		...
		{TEXT("compile_blueprint"), TEXT("blueprint"), TEXT("Compile a Blueprint asset after edits."), TEXT("{\"asset_path\":\"/Game/Path/BP_Actor.BP_Actor\"}"), Schema(Prop(TEXT("asset_path"), StringProp()), Required({TEXT("asset_path")})), TEXT("blueprint_graph")},
